          ...
          <div className="">
            <div className=" flex items-center justify-between py-2 ">
              ...
              <p
                ...
                // className={
                //   isShow
                //     ? `cursor-pointer relative before:absolute before:top-[50%] before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:w-screen before:h-screen before:rounded-full before:bg-black before:bg-opacity-80 transition before:duration-1000 z-[90]`
                ...
                // }
              >
                <PiListBold className="text-3xl cursor-pointer" />
              </p>
            </div>

            {isShow === true && (
              <div className="relative w-screen h-screen bg-white bg-opacity-0">
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{
                    opacity: 1,
                  ...
                  exit={{ opacity: 1 }}
                  className="w-[340px] h-[410px] md:w-[400px] md:h-[420px] rounded-xl bg-opacity-70 bg-white fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[100] p-10"
                >
                  <FaXmark
                    onClick={() => {
                      setIsShow(false);
                ...
                <div className="fixed inset-0 bg-black bg-opacity-65 z-[99]"></div>
              </div>
            )}
          </div>
        </div>
